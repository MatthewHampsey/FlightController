...
BOOST_AUTO_TEST_CASE(test_control_vector)
{
    ...
    TEST_CHECK_FLOAT_VALUE(
        control_vector[0],
        I(0, 0) * (49.0f * (target_euler_angles[0] - euler_angles[0]) + 3.5f * (target_euler_derivatives[0] - euler_derivatives[0])),
        0.0001f);
    TEST_CHECK_FLOAT_VALUE(
        control_vector[1],
        I(1, 1) * (49.0f * (target_euler_angles[1] - euler_angles[1]) + 3.5f * (target_euler_derivatives[1] - euler_derivatives[1])),
        0.0001f);
    TEST_CHECK_FLOAT_VALUE(
        control_vector[2],
        I(2, 2) * (49.0f * (target_euler_angles[2] - euler_angles[2]) + 3.5f * (target_euler_derivatives[2] - euler_derivatives[2]) - euler_derivatives[0] * euler_derivatives[1]),
        0.0001f);
}