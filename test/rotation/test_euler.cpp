...
BOOST_AUTO_TEST_CASE(test_yaw) {
    ...
    BOOST_CHECK_SMALL(x_hat_rot[0] - (-1.0f), 0.001f);
    BOOST_CHECK_SMALL(x_hat_rot[1] - 0.0f, 0.001f);
    BOOST_CHECK_SMALL(x_hat_rot[2] - 0.0f, 0.001f);

    Penguin::Vector3f y_hat{0.0f, 1.0f, 0.0f};
    auto y_hat_rot = yaw_rotation.apply(y_hat);

    BOOST_CHECK_SMALL(y_hat_rot[0] - 0.0f, 0.001f);
    BOOST_CHECK_SMALL(y_hat_rot[1] - (-1.0f), 0.001f);
    BOOST_CHECK_SMALL(y_hat_rot[2] - 0.0f, 0.001f);

    Penguin::Vector3f z_hat{0.0f, 0.0f, 1.0f};
    auto z_hat_rot = yaw_rotation.apply(z_hat);

    BOOST_CHECK_SMALL(z_hat_rot[0] - 0.0f, 0.001f);
    BOOST_CHECK_SMALL(z_hat_rot[1] - 0.0f, 0.001f);
    BOOST_CHECK_SMALL(z_hat_rot[2] - 1.0f, 0.001f);
}
...
BOOST_AUTO_TEST_CASE(test_pitch_then_yaw) {
    ...
    BOOST_CHECK_SMALL(x_hat_rot[0] - (-forty_five_degrees), 0.001f);
    BOOST_CHECK_SMALL(x_hat_rot[1] - 0.0f, 0.001f);
    BOOST_CHECK_SMALL(x_hat_rot[2] - (-forty_five_degrees), 0.001f);
    ...
    BOOST_CHECK_SMALL(z_hat_rot[0] - (-forty_five_degrees), 0.001f);
    BOOST_CHECK_SMALL(z_hat_rot[1] - 0.0f, 0.001f);
    BOOST_CHECK_SMALL(z_hat_rot[2] - forty_five_degrees, 0.001f);
}
...
BOOST_AUTO_TEST_CASE(test_roll_then_yaw) {
    ...
    BOOST_CHECK_SMALL(x_hat_rot[0] - forty_five_degrees, 0.001f);
    BOOST_CHECK_SMALL(x_hat_rot[1] - forty_five_degrees, 0.001f);
    BOOST_CHECK_SMALL(x_hat_rot[2] - 0.0f, 0.001f);

    Penguin::Vector3f y_hat{0.0f, 1.0f, 0.0f};
    auto y_hat_rot = roll_rotation.apply(y_hat);

    BOOST_CHECK_SMALL(y_hat_rot[0] - forty_five_degrees, 0.001f);
    BOOST_CHECK_SMALL(y_hat_rot[1] - (-forty_five_degrees), 0.001f);
    BOOST_CHECK_SMALL(y_hat_rot[2] - 0.0f, 0.001f);
