...
struct Vector3f::impl{
  ...
  Vector3f::Vector3f(const std::initializer_list<float>& l):_impl{new impl{l}}
  {
  }
  ...
  void Vector3f::impl_deleter::operator()(Vector3f::impl* ptr) const{delete ptr;}


  float& Vector3f::operator[](size_t i){
