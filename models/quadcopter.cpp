...
void Quadcopter::step(float time_delta, const Vector3f& thrust, 
        ...
        auto _bodyframe_to_world = ZYXEulerToRotationMatrix(_euler_angles[2],
                                                            _euler_angles[1],
                                                            _euler_angles[0]);
        auto linear_acceleration = (1.0f/_mass)*
            (gravity + _bodyframe_to_world.apply(thrust) + drag);
        auto angular_velocity = ZYXEulerToBodyFrameAngularVelocity(_euler_angles,
                                   _euler_derivatives);
        ...
        _euler_derivatives = BodyFrameAngularVelocityToZYXEulerDerivatives(_euler_angles, angular_velocity);
